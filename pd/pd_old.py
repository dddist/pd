...
class Dashboard(FloatLayout):
    def __init__(self, **kwargs):
        ...
        # KM
        self.km= Label(text='---', font_name = 'Idigital-Medium.otf', halign="right", text_size=self.size, font_size=42, pos=(-695,-160))
        self.add_widget(self.km)  
        
        # Moto Hour
        self.moto_hour = Label(text='---', font_name = 'Idigital-Medium.otf', halign="right", text_size=self.size, font_size=42, pos=(690,-160))
